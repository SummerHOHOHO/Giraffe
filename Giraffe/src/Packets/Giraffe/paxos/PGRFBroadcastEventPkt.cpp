...
PGRFBroadcastEventPkt::PGRFBroadcastEventPkt(U32 paxosType, U32 myid, U32 epoch, U64 txid, String skey, String svalue, U8 subtype)
...
U32 PGRFBroadcastEventPkt::getLength() const 
{
	...
	iLen += sizeof(U32) * 3 + sizeof(U64) + m_sValue.size() + 5 + m_sKey.size() + 5;
	return iLen;
